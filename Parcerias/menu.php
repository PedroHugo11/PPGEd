		    ...
		    <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item" href="../O Programa/docentes.php">DOCENTES</a>
							<a class="dropdown-item" href="../O Programa/linhaDePesquisa.php">LINHAS DE PESQUISA</a>
		      ...
		      <li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="intercambio.php">INTERCÂMBIOS</a>
							<a class="dropdown-item" href="conveniosNacionais.php">CONVÊNIOS NACIONAIS</a>
							<a class="dropdown-item" href="conveniosInternacionais.php">CONVÊNIOS INTERNACIONAIS</a>
						</div>
		      </li>
		      <li class="nav-item">
