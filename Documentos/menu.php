		  ...
		  <div class="collapse navbar-collapse" id="navbarSupportedContent">
		    <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="regimento.php">REGIMENTO</a>
							<a class="dropdown-item" href="reconhecimentoDiploma.php">RECONHECIMENTO DE DIPLOMAS</a>
							<a class="dropdown-item" href="resolucoes.php">RESOLUÇÕES</a>
							<a class="dropdown-item" href="formulario.php">FORMULÁRIOS</a>
