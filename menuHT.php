		    ...
		    <ul class="navbar-nav ml-auto">
			  ...
			  <li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item" href="#">LINHAS DE PESQUISA</a>
							<a class="dropdown-item" href="#">BANCO DE TESES E DISSERTAÇÕES</a>
		      ...
		      <li class="nav-item">
		        <a class="nav-link" href="sobre.php">SELEÇÃO</a>
		      </li>
		      <li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="">INTERCÂBIOS</a>
